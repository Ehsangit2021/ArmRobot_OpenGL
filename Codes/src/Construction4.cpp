...
void keyboard(unsigned char key, int x, int y) {
    switch (key) {
        case 'z':
            First_Element += 5.0f;
            std::cout << "First_Element: " << First_Element << ", Around Z axis\n";
        ...
        case 'a':
            Second_Element += 5.0f;
            std::cout << "Second_Element: " << Second_Element << ", Around X axis\n";
        ...
        case 'q':
            Third_Element += 5.0f;
            std::cout << "Third_Element: " << Third_Element << ", Around Y axis\n";
...
void display() {
    ...
    drawCylinder(0.4,2.5,50);
    glTranslatef(0.0, 0.0, 2.5);

    glColor3f(0.5, 0.5, 0.5); // Gray color
    glRotatef(First_Element, 0.0, 0.0, 1.0); // Rotate around z-axis
    glRotatef(Second_Element, 0.1, 0.0, 0.0); // Rotate around x-axis
    drawJoint(0.7f);

    glColor3f(1.0, 0.5, 0.0); // Yellow color
    drawCylinder(0.4,2,50);

    // glColor3f(0.5, 0.5, 0.5); // Gray color
    // glRotatef(Third_Element, 0.0, 1.0, 0.0); // Rotate around z-axis
    // glRotatef(Fourth_Element, 0.0, 0.0, 1.0); // Rotate around z-axis
    // drawJoint(0.7f);
